...
never touched by the CLI and never committed. `authority/` holds that
project's own durable authority such as architecture notes and decision
records, and is never committed either. A repository holding a legacy
